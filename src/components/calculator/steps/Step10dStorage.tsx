  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-center text-xs text-muted-foreground">
        Price includes access during office hours (Mon-Sat 8am-6pm)
      </p>
...
function StorageSizeCard({
  ...
  return (
    ...
    >
      {/* Badge */}
      {badge && (
        <div className="absolute -top-2 left-1/2 -translate-x-1/2 px-2 py-0.5 text-[10px] font-medium bg-primary text-primary-foreground rounded-full whitespace-nowrap">
          {badge}
        </div>
      )}
